                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 mx-auto">
                                    <div class="col-12 mx-auto mb-3 d-flex justify-content-center">
                                        <h3>Update the product with id = ${newProduct.id}</h3>
                                    </div>
                                    ...
                                    <form:form enctype="multipart/form-data" action="/admin/product/update" modelAttribute="newProduct" class="row">
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input class="form-control" type="file" id="imageFile" accept=".png, .jpg, .jpeg" name="thienFile" />
                                        </div>
