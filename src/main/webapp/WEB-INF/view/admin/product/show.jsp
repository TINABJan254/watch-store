                    ...
                    <div class="mb-3">
                        ...
                        <c:if test="${totalPages > 0}">
                            <div class="inner-pagination">
                                <a class="${1 eq currentPage ? 'page-link disabled' : 'page-link'}" href="/admin/product?limit=${limit}&page=${currentPage - 1}">&laquo;</a>
    
                                <c:forEach begin="0" end="${totalPages - 1}" varStatus="loop">
                                    <a class="${(loop.index + 1) eq currentPage ? 'page-link active' : 'page-link'}" href="/admin/product?limit=${limit}&page=${loop.index + 1}">${loop.index + 1}</a>
                                </c:forEach>
    
                                <a class="${totalPages eq currentPage ? 'page-link disabled' : 'page-link'}" href="/admin/product?limit=${limit}&page=${currentPage + 1}">&raquo;</a>
